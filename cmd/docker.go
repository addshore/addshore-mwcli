...
var dockerStartCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		exec.RunCommand(options, docker.DockerComposeCommand("up", "-d"))
...
var dockerExecCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		if NoTTY {
			...
			exec.RunCommand(options, docker.DockerComposeCommand("exec", args...))
		} else {
			exec.RunTTYCommand(options, docker.DockerComposeCommand("exec", args...))
		}
...
var dockerDestroyCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		exec.RunTTYCommand(options, docker.DockerComposeCommand("rm", runArgs...))
...
var dockerStopCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		exec.RunCommand(options, docker.DockerComposeCommand("stop"))
	},
}
...
var dockerStatusCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		exec.RunCommand(options, docker.DockerComposeCommand("ps"))
	},
}
...
func printSuccess() {
	...
	exec.RunCommand(options, docker.DockerComposeCommand("port", "mediawiki", "8080"))
